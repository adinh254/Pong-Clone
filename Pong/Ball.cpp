...
const GLfloat Ball::DEFAULT_SPEED = 6.0f;
const GLfloat Ball::BALL_WIDTH = 10.0f;
const GLfloat Ball::BALL_HEIGHT = 10.0f;
const GLfloat Ball::SPEED_CEILING = 15.0f;
const GLfloat Ball::SPEED_FLOOR = 4.0f;
...
void Ball::spawn()
{
	...
	} while( ( ( random_velocity.y > -2.0f ) && ( random_velocity.y < 2.0f ) ) || ( ( random_velocity.x < 4.0f ) && ( random_velocity.x > -4.0f) ) );
